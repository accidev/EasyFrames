...
function Core:MovePlayerFrameBars()
    ...
    PlayerStatusTexture:SetHeight(75)

    self:MoveRegion(PlayerFrameHealthBar, "CENTER", PlayerFrame, "CENTER", 49, 14)
    self:MoveRegion(PlayerFrameManaBar, "CENTER", PlayerFrame, "CENTER", 49, -7)
...
function Core:MoveTargetFrameBars()
    ...
    self:MoveRegion(TargetFrameManaBar, "CENTER", TargetFrame, "CENTER", -50, -7)
    self:MoveRegion(TargetFrameNumericalThreat, "CENTER", TargetFrame, "CENTER", 44, 48)

    self:MoveRegion(TargetFrameManaBar.TextString, "CENTER", TargetFrameManaBar, "CENTER", 0, 1)
end
...
function Core:MoveFocusFrameBars()
    ...
    self:MoveRegion(FocusFrameManaBar, "CENTER", FocusFrame, "CENTER", -50, -7)
    self:MoveRegion(FocusFrameNumericalThreat, "CENTER", FocusFrame, "CENTER", 44, 48)

    self:MoveRegion(FocusFrameManaBar.TextString, "CENTER", FocusFrameManaBar, "CENTER", 0, 1)
end
